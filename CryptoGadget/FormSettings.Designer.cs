namespace CryptoGadget {
    partial class FormSettings {
        ...
        private void InitializeComponent() {
			...
			this.numPagesMaxRotatePage = new System.Windows.Forms.NumericUpDown();
			this.checkPagesAutoRotate = new System.Windows.Forms.CheckBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.numPagesMaxRotatePage)).BeginInit();
        ...
        "he icons won\'t be overwrritten, even if they are different)");
        ...
        "DayPct when they are positive.");
			...
			this.numPagesDefault.Location = new System.Drawing.Point(100, 19);
        ...
        "");
			...
			this.label44.Text = "Max Rotate Page:";
			this.toolTip1.SetToolTip(this.label44, "Rotate until the selected page, then the next rotation\r\nwill be to the page 0");
			// 
			// buttonDonationQrLTC
			// 
    ...
    "the \'Check\' button)";
			...
			this.groupBox4.Controls.Add(this.numPagesMaxRotatePage);
			this.groupBox4.Controls.Add(this.checkPagesAutoRotate);
			...
			this.groupBox4.Size = new System.Drawing.Size(212, 146);
			...
			this.label34.Text = "Rotate Rate (sec):";
			// 
			// numPagesRotateRate
			// 
			this.numPagesRotateRate.Location = new System.Drawing.Point(100, 91);
			...
			this.numPagesRotateRate.TabIndex = 81;
            ...
            0});
			// 
			// numPagesMaxRotatePage
			// 
			this.numPagesMaxRotatePage.Location = new System.Drawing.Point(100, 117);
			this.numPagesMaxRotatePage.Maximum = new decimal(new int[] {
            9,
            0,
            0,
            0});
			this.numPagesMaxRotatePage.Name = "numPagesMaxRotatePage";
			this.numPagesMaxRotatePage.Size = new System.Drawing.Size(100, 20);
			this.numPagesMaxRotatePage.TabIndex = 80;
			// 
			// checkPagesAutoRotate
			// 
			this.checkPagesAutoRotate.AutoSize = true;
			this.checkPagesAutoRotate.Location = new System.Drawing.Point(74, 68);
			this.checkPagesAutoRotate.Name = "checkPagesAutoRotate";
			this.checkPagesAutoRotate.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.checkPagesAutoRotate.Size = new System.Drawing.Size(83, 17);
			this.checkPagesAutoRotate.TabIndex = 79;
			this.checkPagesAutoRotate.Text = "Auto Rotate";
			this.checkPagesAutoRotate.UseVisualStyleBackColor = true;
			// 
			...
			this.groupBox1.Controls.Add(this.numMetricsRowsValues);
    ...
    " more digits than the allowed. ";
			...
			this.comboTheme.Click += new System.EventHandler(this.DropDownOnClick);
			// 
			// label10
			// 
			...
			// coinGridAlertType
			// 
			this.coinGridAlertType.HeaderText = "Alert";
			this.coinGridAlertType.MaxInputLength = 5;
			this.coinGridAlertType.Name = "coinGridAlertType";
			this.coinGridAlertType.ReadOnly = true;
			this.coinGridAlertType.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
			this.coinGridAlertType.Width = 32;
			// 
			// tabControl1
			// 
			...
			// tabPage5
			// 
			this.tabPage5.Controls.Add(this.checkChartShowMinMax);
			...
			this.label37.Text = "Positive Candle:";
			// 
			// label38
			// 
			...
			this.buttonDefaultCharts.Location = new System.Drawing.Point(373, 407);
			this.buttonDefaultCharts.Name = "buttonDefaultCharts";
			this.buttonDefaultCharts.Size = new System.Drawing.Size(75, 23);
			this.buttonDefaultCharts.TabIndex = 76;
			...
			this.tabPage6.Controls.Add(this.buttonDonationQrDASH);
			this.tabPage6.Controls.Add(this.buttonDonationQrETH);
			this.tabPage6.Controls.Add(this.buttonDonationQrBCH);
			this.tabPage6.Controls.Add(this.buttonDonationQrBTC);
			this.tabPage6.Controls.Add(this.buttonDonationCopyBCH);
			this.tabPage6.Controls.Add(this.label20);
			this.tabPage6.Controls.Add(this.textBoxDonationBCH);
			this.tabPage6.Controls.Add(this.linkLabel2);
			this.tabPage6.Controls.Add(this.label23);
			this.tabPage6.Controls.Add(this.label32);
			this.tabPage6.Controls.Add(this.linkLabel1);
			this.tabPage6.Controls.Add(this.labelCryptoGadgetVersion);
			this.tabPage6.Controls.Add(this.buttonDonationCopyLTC);
			this.tabPage6.Controls.Add(this.buttonDonationCopyDASH);
			this.tabPage6.Controls.Add(this.buttonDonationCopyETH);
			this.tabPage6.Controls.Add(this.buttonDonationCopyBTC);
			this.tabPage6.Controls.Add(this.label17);
			this.tabPage6.Controls.Add(this.textBoxDonationDASH);
			this.tabPage6.Controls.Add(this.label16);
			this.tabPage6.Controls.Add(this.textBoxDonationLTC);
			this.tabPage6.Controls.Add(this.label15);
			this.tabPage6.Controls.Add(this.textBoxDonationETH);
			this.tabPage6.Controls.Add(this.label2);
			this.tabPage6.Controls.Add(this.textBoxDonationBTC);
			this.tabPage6.Location = new System.Drawing.Point(4, 22);
			this.tabPage6.Name = "tabPage6";
			this.tabPage6.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage6.Size = new System.Drawing.Size(454, 436);
			...
			this.textBoxDonationBCH.TabIndex = 44;
			...
			this.labelCryptoGadgetVersion.Location = new System.Drawing.Point(174, 182);
			...
			this.labelCryptoGadgetVersion.TabIndex = 39;
			...
			this.textBoxDonationDASH.TabIndex = 33;
			...
			this.textBoxDonationLTC.TabIndex = 31;
			...
			this.textBoxDonationETH.TabIndex = 29;
			...
			this.textBoxDonationBTC.TabIndex = 27;
    ...
    " more digits than the allowed. ";
			...
			this.buttonApply.Location = new System.Drawing.Point(226, 468);
			...
			// buttonPageSwap
			// 
			this.buttonPageSwap.Location = new System.Drawing.Point(133, 468);
			this.buttonPageSwap.Name = "buttonPageSwap";
			this.buttonPageSwap.Size = new System.Drawing.Size(42, 23);
			this.buttonPageSwap.TabIndex = 22;
			...
			this.Controls.Add(this.buttonPageSwap);
			...
			((System.ComponentModel.ISupportInitialize)(this.numPagesMaxRotatePage)).EndInit();
		...
		private System.Windows.Forms.NumericUpDown numPagesMaxRotatePage;
		private System.Windows.Forms.CheckBox checkPagesAutoRotate;
